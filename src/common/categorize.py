...
CATEGORIES: dict[str, list[str]] = {
    "CR": [
        ...
        # 소부장(소재·부품·장비) 생산시설 — 반도체·디스플레이 생태계 (영업팀 2026-06-04)
        "소부장", "반도체소부장", "반도체장비", "반도체소재", "반도체부품",
        "디스플레이장비", "OLED장비", "증착장비", "노광장비", "식각장비",
        "포토레지스트", "특수가스", "산업가스", "전공정장비", "후공정장비",
    ],
    "일반생산": [
        ...
        # 첨단 산업시설 (영업팀 2026-06-04)
        "첨단산업", "첨단제조", "첨단산업단지", "국가산단", "국가첨단전략산업",
        "소부장특화단지", "산업시설", "생산시설",
    ],
    "제약/바이오": [
    ...
    "데이터센터": [
        # 데이터센터·IDC — 첨단 산업시설 (클린전원·냉각·전산실 시공) (영업팀 2026-06-04)
        "데이터센터", "데이터센터구축", "인터넷데이터센터", "하이퍼스케일",
        "클라우드데이터센터", "AI데이터센터", "코로케이션",
        "데이터센터단지", "데이터센터캠퍼스", "전산센터",
    ],
}

# 카테고리 표시 순서 (UI 일관성)
CATEGORY_ORDER = ["CR", "데이터센터", "일반생산", "제약/바이오", "식품/음료", "R&D", "이차전지", "기타"]
