...
# 추정공사비 상한 (만원) — CLAUDE.md 영업 타겟 '450억 ~ 1조 미만'.
# 1조(=100,000,000 만원) 이상은 단일 건물 인허가가 아니라 부지·단지 totArea 가
# 통째로 잡힌 데이터 아티팩트 (거제 아주동 ~99만㎡ → 14,837억 등). 영업 타겟 밖이라 컷.
MAX_COST_MAN: int = 10000 * 10000   # 1조 = 100,000,000 만원
